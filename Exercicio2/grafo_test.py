...
class TestGrafo(unittest.TestCase):
    ...
    def test_busca_em_profundidade(self):
      ...
      self.assertEqual(self.g_p.busca_em_profundidade("Z"), ['Z', 'a9', 'T', 'a7', 'C', 'a1','J', 'a2', 'E', 'a4', 'P', 'a6', 'H', '9', 'G', '4', 'K', '5', 'J','M'])
      self.assertEqual(self.g_2.busca_em_profundidade("K"), ['K', '4', 'G', '2', 'A', '1', 'B', '11', 'F', '10', 'H', '13', 'C', '14', 'D', '15', 'E', '3', 'J', '7', 'I'])
      self.assertEqual(self.g_2.busca_em_profundidade("A"),['A', '1', 'B', '11', 'F', '10', 'H', '9', 'G', '4', 'K', '8', 'I','16', 'D'])
    ...
    def test_busca_em_profundidade_recursiva(self):
      ...
      self.assertEqual(self.g_p.busca_em_profundidade_recursiva("Z"), ['Z', 'a9', 'T', 'a7', 'C', 'a1','J', 'a2', 'E', 'a4', 'P', 'a6', 'H', '9', 'G', '4', 'K', '5', 'J','M'])
      self.assertEqual(self.g_2.busca_em_profundidade_recursiva("K"), ['K', '4', 'G', '2', 'A', '1', 'B', '11', 'F', '10', 'H', '13', 'C', '14', 'D', '15', 'E', '3', 'J', '7', 'I'])
      self.assertEqual(self.g_2.busca_em_profundidade_recursiva("A"),['A', '1', 'B', '11', 'F', '10', 'H', '9', 'G', '4', 'K', '8', 'I','16', 'D'])